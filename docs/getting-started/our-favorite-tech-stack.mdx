...
description: "A curated list of our recommended technologies and tools for building modern web applications with clinesp."
---
...
1. Install the development essentials:
    - Follow our [Development Essentials Installation Guide](https://docs.clinesp.bot/getting-started/installing-dev-essentials)
2. Set up Cline's Memory Bank:
    - Follow the [Memory Bank setup instructions](https://docs.clinesp.bot/prompting/cline-memory-bank)
...
2. Check [Cline Documentation](https://docs.clinesp.bot)
