...
💡 **Key Point**: Cline isn't passive - it actively seeks to understand your project. You can either let it explore or guide its focus, especially in [Plan](https://docs.clinesp.bot/features/plan-and-act) mode.
...
-   **Context Window** is the size of the whiteboard itself:
    ...
    -   When the whiteboard is full, you need to erase (clear context) to write more
        -   [How Cline manages context under the hood](https://clinesp.bot/blog/understanding-the-new-context-window-progress-bar-in-cline)
...
1. **Evergreen Project Context (i.e.** [**Memory Bank**](https://docs.clinesp.bot/prompting/cline-memory-bank)**)**
...
2. **Task-Specific Context (i.e.** [**Structured Approach**](https://clinesp.bot/blog/building-advanced-software-with-cline-a-structured-approach)**)**
...
3. **Team Projects**
    - Share common context files (consider using [.clinerules](https://docs.clinesp.bot/features/cline-rules) files in project roots)
