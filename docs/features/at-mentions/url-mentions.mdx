...
URL mentions let you bring web content directly into your conversation with clinesp. Just type `@` followed by any URL, and Cline can see the content of that webpage without you having to copy and paste anything.
