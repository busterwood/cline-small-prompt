...
Git mentions let you bring your repository's history and changes directly into your conversation with clinesp. You can reference uncommitted changes with `@git-changes` or specific commits with `@[commit-hash]`.
