...
File mentions let you pull any file from your workspace directly into your conversation with clinesp. No more copying and pasting code snippets - just type `@/` and point to the file you need help with.
