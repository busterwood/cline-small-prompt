...
`/reportbug` is an absolute lifesaver when you hit a weird issue with clinesp. Instead of having to remember all the details GitHub wants for a bug report, this command turns Cline into your personal bug reporting assistant.
