...
-   For my team's shared projects, we have a common rule file that ensures consistent code style and documentation practices regardless of who's using clinesp.
