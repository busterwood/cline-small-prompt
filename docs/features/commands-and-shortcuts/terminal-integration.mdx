...
Cline's terminal integration lets you bring your terminal output directly into your conversations with clinesp. Instead of copying and pasting error messages or command results, you can send them to Cline with a simple right-click in the terminal.
...
Alternatively, you can use the [`@terminal`](/features/at-mentions/terminal-mentions) mention to send the full terminal output to clinesp.
