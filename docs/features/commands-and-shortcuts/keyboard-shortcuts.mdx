...
| ------------------------------------------------------------------------------------------ | --------------------------------------------- |
| [`clinesp.openInNewTab`](/features/commands-and-shortcuts/overview)                        | Opens Cline in a new editor tab               |
| [`clinesp.addToChat`](/features/commands-and-shortcuts/code-commands)                      | Adds selected code to Cline chat              |
| [`clinesp.addTerminalOutputToChat`](/features/commands-and-shortcuts/terminal-integration) | Adds terminal output to Cline                 |
| `clinesp.focusChatInput`                                                                   | Focuses the Cline chat input field            |
| [`clinesp.generateGitCommitMessage`](/features/commands-and-shortcuts/git-integration)     | Generates a commit message for staged changes |
| [`clinesp.explainCode`](/features/commands-and-shortcuts/code-commands)                    | Explains selected code                        |
| [`clinesp.improveCode`](/features/commands-and-shortcuts/code-commands)                    | Suggests improvements for selected code       |
| [`clinesp.fixWithCline`](/features/commands-and-shortcuts/code-commands)                   | Fixes code with errors                        |
| `clinesp.SidebarProvider.focus`                                                            | Opens and focuses the Cline sidebar           |
...
| --------------------- | ------------------------------ | ----------------------------------------- | ----------------------------- |
| Open Cline Sidebar    | `Ctrl+Shift+C` / `Cmd+Shift+C` | `clinesp.SidebarProvider.focus`           | Opens the Cline sidebar panel |
| New Task              | `Alt+N`                        | `clinesp.plusButtonClicked`               | Starts a new Cline task       |
| Add Terminal to Cline | `Alt+T`                        | `clinesp.addTerminalOutputToChat`         | Adds terminal output to Cline |
