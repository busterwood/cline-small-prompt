---
title: "LM Studio"
description: "A quick guide to setting up LM Studio for local AI model execution with clinesp."
---

## 🤖 Setting Up LM Studio with Cline

Run AI models locally using LM Studio with clinesp.
...
<Frame>
	<img
		src="https://storage.googleapis.com/cline_public_images/docs/assets/lm-studio-select-model-clinesp.gif"
