---
title: "Mistral"
description: "Learn how to configure and use Mistral AI models, including Codestral, with clinesp. Covers API key setup and model selection."
---
...
3.  **Enter your Codestral API Key** (from `codestral.mistral.ai`) or your La Plateforme API Key (from `api.mistral.ai`) into the appropriate API key field in clinesp.
